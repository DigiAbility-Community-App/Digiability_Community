...
const InvitesScreen = ({ navigation }: Props) => {
  ...
  const handleRespond = useCallback(async (invite: GroupInvite, action: 'accept' | 'decline') => {
    ...
    try {
      ...
      // store update is handled by websocket (invite.accepted / invite.declined)
    } catch (err: any) {
      ...
      <View style={styles.inviteCard}>
        <View style={styles.inviteHeader}>
          ...
          <View style={styles.inviteInfo}>
            ...
            <Text style={styles.inviterText}>Invited as <Text style={{fontWeight: '700', color: '#500088'}}>{item.role}</Text></Text>
          </View>
        </View>
